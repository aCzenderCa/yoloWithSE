...
from ultralytics_local.ultralytics.utils import LOGGER, SETTINGS, TESTS_RUNNING, colorstr
...
try:
    ...
    from ultralytics_local.ultralytics.utils.torch_utils import de_parallel, torch
