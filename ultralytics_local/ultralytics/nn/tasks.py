...
from ultralytics_local.ultralytics.nn.modules import (
    AIFI,
    C1,
    C2,
    C2PSA,
...
from ultralytics_local.ultralytics.utils import DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, colorstr, emojis, yaml_load
from ultralytics_local.ultralytics.utils.checks import check_requirements, check_suffix, check_yaml
from ultralytics_local.ultralytics.utils.loss import (
    E2EDetectLoss,
...
from ultralytics_local.ultralytics.utils.plotting import feature_visualization
from ultralytics_local.ultralytics.utils.torch_utils import (
    fuse_conv_and_bn,
    fuse_deconv_and_bn,
    initialize_weights,
    intersect_dicts,
...
class RTDETRDetectionModel(DetectionModel):
    ...
    def init_criterion(self):
        ...
        from ultralytics_local.ultralytics.models.utils.loss import RTDETRDetectionLoss
...
def torch_safe_load(weight, safe_only=False):
    ...
    Example:
    ```python
    from ultralytics_local.ultralytics.nn.tasks import torch_safe_load
