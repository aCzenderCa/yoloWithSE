...
from ultralytics_local.ultralytics.utils import ARM64, IS_JETSON, IS_RASPBERRYPI, LINUX, LOGGER, PYTHON_VERSION, ROOT, yaml_load
from ultralytics_local.ultralytics.utils.checks import check_requirements, check_suffix, check_version, check_yaml, is_rockchip
from ultralytics_local.ultralytics.utils.downloads import attempt_download_asset, is_url
...
class AutoBackend(nn.Module):
    ...
    def __init__(
        ...
        # PyTorch
            ...
            from ultralytics_local.ultralytics.nn.tasks import attempt_load_weights
        ...
        # TF GraphDef
            ...
            from ultralytics_local.ultralytics.engine.exporter import gd_outputs
        ...
        # NVIDIA Triton Inference Server
            ...
            from ultralytics_local.ultralytics.utils.triton import TritonRemoteModel
    ...
    def forward(self, im, augment=False, visualize=False, embed=None):
        ...
        # CoreML
            ...
            if "confidence" in y:
                ...
                # from ultralytics_local.ultralytics.utils.ops import xywh2xyxy
