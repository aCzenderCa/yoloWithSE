...
from ultralytics_local.ultralytics.utils import DATASETS_DIR, LOGGER, NUM_THREADS, TQDM
...
def convert_dota_to_yolo_obb(dota_root_path: str):
    ...
    Example:
        ```python
        from ultralytics_local.ultralytics.data.converter import convert_dota_to_yolo_obb
...
def create_synthetic_coco_dataset():
    ...
    Examples:
        >>> from ultralytics_local.ultralytics.data.converter import create_synthetic_coco_dataset
