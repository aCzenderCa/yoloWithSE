...
def parse_requirements(file_path=ROOT.parent / "requirements.txt", package=""):
    ...
    Example:
        ```python
        from ultralytics_l.utils.checks import parse_requirements
...
def check_yolo(verbose=True, device=""):
    ...
    from ultralytics_l.utils.torch_utils import select_device
...
def collect_system_info():
    ...
    from ultralytics_l.utils import ENVIRONMENT  # scope to avoid circular import
    from ultralytics_l.utils.torch_utils import get_cpu_info, get_gpu_info
...
def check_amp(model):
    ...
    """
    from ultralytics_l.utils.torch_utils import autocast
