...
from ultralytics_l.utils.torch_utils import model_info
...
class NAS(Model):
    ...
    This class provides an interface for the YOLO-NAS models and extends the `Model` class from ultralytics_l engine.
