---
description: Explore the PoseTrainer class for training pose models using YOLO from ultralytics_local.ultralytics. Includes initialization, model configuration, and plotting methods.
